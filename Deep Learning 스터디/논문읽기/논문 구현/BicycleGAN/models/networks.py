...
def define_G(input_nc, output_nc, nz, ngf, netG='unet_128', norm='batch', nl='relu',
             use_dropout=False, init_type='xavier', init_gain=0.02, device='', where_add='input', upsample='bilinear'):
    net = None
...
def define_D(input_nc, ndf, netD, norm='batch', nl='lrelu', init_type='xavier', init_gain=0.02, num_Ds=1,device=''):
    net = None
    norm_layer = get_norm_layer(norm_type=norm)
...
def define_E(input_nc, output_nc, ndf, netE,
             norm='batch', nl='lrelu',
             init_type='xavier', init_gain=0.02, device='', vaeLike=False):
    net = None
    norm_layer = get_norm_layer(norm_type=norm)
