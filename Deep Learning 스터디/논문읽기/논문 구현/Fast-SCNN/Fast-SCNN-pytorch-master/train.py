...
class Trainer(object):
    def __init__(self, args):
        ...
        # create network
        self.model = fast_scnn.FastSCNN(num_classes=21, aux=False)
        ...
        # create criterion
        self.criterion = torch.nn.CrossEntropyLoss(ignore_index=-1).to(args.device)
    ...
    def train(self):
        ...
        for epoch in range(self.args.start_epoch, self.args.epochs):
            ...
            torch.save(self.model, f"D:\\temp\\save_model\\Fast-Scnn\\{epoch}.pth")
