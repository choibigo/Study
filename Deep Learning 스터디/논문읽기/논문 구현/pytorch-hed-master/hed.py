...
# 4. Files and folders.
parser.add_argument('--vgg16_caffe',      default=r'D:\workspace\Study\Study\Deep Learning 스터디\논문읽기\논문 구현\pytorch-hed-master\vgg\5stage-vgg.py36pickle',                help='Resume VGG-16 Caffe parameters.')
...
parser.add_argument('--output',           default='D:\hed_out_dir',        help='Output folder.')
parser.add_argument('--dataset',          default='D:\workspace\data\BSDS', help='HED-BSDS dataset folder.')
# 5. Others.
...
def train(train_loader, net, opt, lr_schd, epoch, save_dir):
    ...
    for batch_index, (images, edges) in enumerate(tqdm(train_loader)):
        ...
        if batch_index % args.print_freq == args.print_freq - 1:
            ...
            preds_list_and_edges = preds_list + [edges] + [images]
